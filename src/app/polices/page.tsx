export default function Polices() {
	return (
		<>
			...
			<ul>
				...
				<li>
					<p>
						...
						this Privacy Policy) refers to okami.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Website</strong> refers to Okami, accessible from{" "}
						<a
							href="https://go.myokami.xyz"
							rel="external nofollow noopener"
							target="_blank"
						>
							https://go.myokami.xyz
						</a>
						.
					</p>
				</li>
			...
			<ul>
				<li>By email: contato@daviribeiro.com</li>
			</ul>
		</>
	);
}
